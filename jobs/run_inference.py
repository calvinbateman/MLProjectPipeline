...
print(f"  min    : {fraud_proba.min():.6f}")
print(f"  max    : {fraud_proba.max():.6f}")
print(f"  mean   : {fraud_proba.mean():.6f}")
print(f"  median : {float(sorted(fraud_proba)[len(fraud_proba)//2]):.6f}")
print(f"  prob > 0.01  : {(fraud_proba > 0.01).sum()}")
print(f"  prob > 0.05  : {(fraud_proba > 0.05).sum()}")
print(f"  prob > 0.10  : {(fraud_proba > 0.10).sum()}")
print(f"  prob > 0.30  : {(fraud_proba > 0.30).sum()}")
print(f"  prob > 0.50  : {(fraud_proba > 0.50).sum()}")
print(f"================================\n")
